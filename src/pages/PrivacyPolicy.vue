...
<template>
    <FrontLayout>
        <div class="privacy-policy">
            <h2>隱私權條款</h2>
            <p>
                非常歡迎您光臨「TibaEAT提膳家網站」（以下簡稱本網站），為了讓您能夠安心使用本網站的各項服務與資訊，特此向您說明本網站的隱私權保護政策，以保障您的權益，請您詳閱下列內容：<br>
                <br>
                一、隱私權保護政策的適用範圍
                ...
                <br>
                八、聯繫管道
                對於本站之隱私權政策有任何疑問，或者想提出變更、移除個人資料之請求，請藉由以下資訊聯繫我們:<br>
                <br>
                公司名稱: TibaEAT提膳家<br>
                Email: tibaeat@gmail.com
            </p>
        </div>
        <Gotop />
    </FrontLayout>
